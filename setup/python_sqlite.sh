# To get started:
# sudo wget https://raw.githubusercontent.com/hammygoonan/Resources/master/setup/python_sqlite.sh -O setup.sh && sh setup.sh
#
...
sudo apt-get install -y fail2ban git nginx python3.5 nodejs build-essential sqlite3 python3-pip python3-dev
